...
class Eight_Queens_Problem:
	...
	# Stochastisches Bergsteigen: n ̈achster Zustand wird zuf ̈alligausgew ̈ahlt.
	# First-choice: Nachfolger werden zuf ̈allig erzeugt bis einneuer identifiziert wird.
	# Random-restart: Restart von einem zuf ̈allig generiertenZustand, falls die Suche nicht fortschreitet.
